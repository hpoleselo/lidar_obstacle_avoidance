...
if __name__ == '__main__':
    ...
    downsampled_pc = utils.downsample(pcd)

    filter_boundaries = utils.get_pass_through_filter_boundaries(pcd_points)
    filtered_pc = utils.pass_through_filter(filter_boundaries, downsampled_pc)
